...
gh repo create praxia --public --source=. --description "Specialized multi-agent orchestrator with cyclic personal/organizational memory" --push

# または手動で:
#   1. GitHub.com で praxia リポジトリを作成 (空)
#   2. git remote add origin git@github.com:<your-org>/praxia.git
